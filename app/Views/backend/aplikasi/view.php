        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('aplikasi/tambah'); ?>" method="post" class="tambah">
                        <?= csrf_field() ?>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select name="halaman" class="form-control">
                                        ...
                                        <?php foreach ($prodi as $item_prodi) : ?>
                                            <option value="<?= $item_prodi['slug'] ?>"><?= $item_prodi['prodi'] ?></option>
                                        <?php endforeach ?>
                                    </select>
                ...
                <tbody>
                    <?php foreach ($aplikasi as $item) : ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group dropright">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <!-- button hapus modal-->
                                        <a href="<?= base_url('aplikasi/hapus/' . $item['id']); ?>" class="dropdown-item hapus">
                                                    ...
                                                    <div class="modal-body" style="text-align:left ;">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <label class="text-primary">Halaman</label>
                                                                <select name="halaman" class="form-control">
                                                                    <option value="<?= $item['halaman'] ?>"><?= $item['halaman'] ?></option>
                                                                    <option value="Fakultas">Fakultas</option>
                                                                    <?php foreach ($prodi as $item_prodi) : ?>
                                                                        <option value="<?= $item_prodi['slug'] ?>"><?= $item_prodi['prodi'] ?></option>
                                                                    <?php endforeach ?>
                            ...
                            <td><?= $item['halaman'] ?></td>
                            <td><?= $item['nama'] ?></td>
                            <td> <input type="text" class="form-control" readonly value="<?= $item['link'] ?>"></td>
                            <td style="text-align: center;"><img src="<?= base_url('writable/uploads/content/aplikasi/' . $item['gambar'] . ''); ?>" width="100px"></td>
                            <td style="min-width: 75px;max-width: 300px; white-space: normal;"></span><span class="badge badge-pill badge-secondary">
                                    <?= $item['timestamp'] ?>
                                </span><br><span class="badge badge-pill badge-warning"><?= $item['admin'] ?></span>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
