            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.peminatan) {
                            $('.peminatan').addClass('is-invalid');
                            $('.errorpeminatan').html(response.error.peminatan);
                        } else {
                            $('.peminatan').removeClass('is-invalid');
                            $('.errorpeminatan').html('');
                        }
                        if (response.error.pohon) {
                            $('.pohon').addClass('is-invalid');
                            $('.errorpohon').html(response.error.pohon);
                        } else {
                            $('.pohon').removeClass('is-invalid');
                            $('.errorpohon').html('');
                        }
                        if (response.error.cabang) {
                            $('.cabang').addClass('is-invalid');
                            $('.errorcabang').html(response.error.cabang);
                        } else {
