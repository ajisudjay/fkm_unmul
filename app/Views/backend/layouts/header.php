    ...
    <head>
        ...
        <meta name="description" content="FKM UNMUL">
        <meta name="keywords" content="FKM UNMUL">
        <meta name="author" content="PIXINVENT">
        <title><?= $title ?> - FKM UNMUL</title>
        <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('/img/logo/unmul.png'); ?>">
